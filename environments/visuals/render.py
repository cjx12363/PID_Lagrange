...
_icons_dir = os.path.join(_current_dir, "icons")

# Image URLs for graph nodes

icons = {
    "cpo": os.path.join(_icons_dir, "cpo.png"),
    "transformer": os.path.join(_icons_dir, "transformer.png"),
    "charger_1": os.path.join(_icons_dir, "charging-station_1_port.png"),
    "charger_2": os.path.join(_icons_dir, "charging-station_2_ports.png"),
    "charger_wallbox": os.path.join(_icons_dir, "charger_wallbox.png"),
    "ev": os.path.join(_icons_dir, "ev.png")
}
...
class Renderer():
    ...
    def __init__(self, env):
        ...
        image_path = os.path.join(_icons_dir, "logo.png")
